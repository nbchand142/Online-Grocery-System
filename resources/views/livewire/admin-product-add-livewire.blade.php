<div>
    ...
    <div class="w-full max-w-xs">
        <form class="bg-blue shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <input class="shadow appearance-none border border rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline"  type="text" wire:model="category_id" placeholder="enter category_id">
